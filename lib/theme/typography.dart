...
class CustomTypography {
  static TextTheme textTheme = TextTheme(
      headline1: GoogleFonts.montserrat(fontSize: 96, fontWeight: FontWeight.bold, color: Colors.white),
      headline2: GoogleFonts.montserrat(fontSize: 60, fontWeight: FontWeight.bold, color: Colors.white),
      headline3: GoogleFonts.montserrat(fontSize: 48, fontWeight: FontWeight.bold, color: Colors.white),
      headline4: GoogleFonts.montserrat(fontSize: 34, fontWeight: FontWeight.bold, color: Colors.white),
      ...
      caption: GoogleFonts.montserrat(fontSize: 13),
